        ...
        findViewById(R.id.button).setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (val == 1) {
                    ...
                    intent2.putExtra("fe", ED + " votre reponse est non");
                    Toast.makeText(getApplicationContext(), "Merci pour votre participation", Toast.LENGTH_LONG).show();
                    setResult(2, intent2);
                    finish();
                ...
                if (val == 0) {
                    EditText S = findViewById(R.id.textView2);
                    String ED = S.getText().toString();
                    intent2.putExtra("fe", ED + " votre reponse est oui");
                    Toast.makeText(getApplicationContext(), "Merci pour votre participation", Toast.LENGTH_LONG).show();
                    setResult(2, intent2);
                    finish();
                }
